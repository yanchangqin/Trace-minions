...
while(n<1000):
    ...
    if os.path.isdir("D://project-cnn/backgrand") != True:
        os.makedirs("D://project-cnn/backgrand")
    with open("testpic.txt","a") as f:
        ...
        for i in s:
            ...
            f.write("\n")
            #保存图片
            urllib.request.urlretrieve(i,"D://project-cnn/backgrand/pic.{num}.jpg".format(num=j))
            j+=1
        f.close()
